...
- 紐を通すための穴（直径2mm）は土台と、上のパーツ両方に描画してください。
- 土台は、背景のパスを利用すると作りやすいです。  
  例）背景パス > 周りの四角のパスを削除後、塗りなし（パスを赤で表現）  
   <img src="../img/2/background1.jpg" width="200px">
  <img src="../img/2/background2.jpg" width="200px">

パーツごとの枠を描画したら、利用するアクリル板ごとに別ファイルに移し、レーザーカッターでカットします。  
例）illustratorで作成した、レーザーカッターに渡すデータ（パスを赤で表現）  
...
1. 土台と上に置くパーツを接着します。以下の画像のようなボンドで行います。  
   <img src="../img/4/bond.jpg" width="300px">
